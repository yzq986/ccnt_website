...
class Browser:
    ...
    def save(self, URL, filename):
        ...
        try:
            ...
            print(e)
            filename = 'sino3060/default'
        
        return filename
        

def save_as_png(URL, filename):
    filename = f'sino3060/{filename}.png'
...
def save_as_pdf(URL, filename):
    filename = f'sino3060/{filename}.pdf'
    if os.path.exists(root_folder + filename):
        return filename
...
#     print('/Users/ziqing.ye/sino3060_website/' + root_folder + filename)
#     profile = {'printing.print_preview_sticky_settings.appState': json.dumps(appState),
#             'savefile.default_directory': '/Users/ziqing.ye/sino3060_website/' + root_folder + filename}
